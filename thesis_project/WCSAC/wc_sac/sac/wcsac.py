...
config5 = {
        ...
        'lidar_num_bins': 16,
        'hazards_num': 6,
        'hazards_locations': [(0,0), (1.5,2), (2.3, -0.25), (-1.0, 1.7), (0.4, -1.7), (1.2, 0.5)],
        'hazards_size': 0.45,
        'hazards_keepout': 0.305,
        }

safe_register(
    id='MyThesisFixedEnv-v0',
    entry_point='safety_gym.envs.mujoco:Engine',
...
def sac(env_fn, actor_fn=mlp_actor, critic_fn=mlp_critic, var_fn=mlp_var, ac_kwargs=dict(), seed=0,
        ...
        reward_scale=1, lr_scale = 1, damp_scale = 0, penalty_per_step=True
        ):
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--penalty_per_step', default=True)
    ...
    sac(lambda : gym.make(args.env), actor_fn=mlp_actor, critic_fn=mlp_critic,
        ...
        fixed_cost_penalty=args.fixed_cost_penalty, cost_constraint=args.cost_constraint, cost_lim = args.cost_lim, lr_scale = args.lr_s, damp_scale = args.damp_s, penalty_per_step=args.penalty_per_step
        )
